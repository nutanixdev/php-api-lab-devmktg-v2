...
#. From the command line, run the following commands.  This will add 3 required packages to our application's **composer.json** file.
   ...
   The screenshot below shows the output from the GuzzleHTTP command above:

   .. figure:: images/composer_install_guzzle.png
...
.. note::
  ...
  **Raw source file for this section, if required:** https://raw.githubusercontent.com/nutanixdev/lab-assets/master/php-lab-v2/VerifyCsrfToken.php
...
.. note::
  ...
  **Raw source file for this section, if required:** https://raw.githubusercontent.com/nutanixdev/lab-assets/master/php-lab-v2/HomeController.php
...
#. Replace the single-line comment block with the following method.
  ...
  The **getIndex** method is the function that will be called when someone browses to the app's root URL (**/**).  At a high level, it does the following things:
...
.. note::
  ...
  **Raw source file for this section, if required:** https://raw.githubusercontent.com/nutanixdev/lab-assets/master/php-lab-v2/dashboard.json
...
#. Inside the new **install** directory, create a file named **dashboard-default.json**.  This file describes the application layout when it is **reverted to default**.  The contents of the file should be as follows.
   ...
   .. note::
      ...
      **Raw source file for this section, if required:** https://raw.githubusercontent.com/nutanixdev/lab-assets/master/php-lab-v2/dashboard-default.json
...
.. note::
  ...
  **Raw source file for this section, if required:** https://raw.githubusercontent.com/nutanixdev/lab-assets/master/php-lab-v2/index.blade.php
...
.. note::
  ...
  **Raw source file for this section, if required:** https://raw.githubusercontent.com/nutanixdev/lab-assets/master/php-lab-v2/web.php
